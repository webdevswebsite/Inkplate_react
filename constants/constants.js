...
// ---FOOTER---
export const permissions = "2022 Inkplate Technologies"
...
export const features = [
  {
    ...
    description: `Over the last year, the explosion of growth within the NFT industry has paved the way for numerous exciting new projects to come to life. Many of these new NFTs offer a compelling investment opportunity for savvy investors who have the foresight to identify them early in their lifespan.`,
    image:
  ...
  },
  {
    ...
    description: `This multiverse ecosystem, which is an LBank Labs project, allows players to use the editing tool to create land and connect with other worlds. Besides creating NFTs, players can invite communities to enter their land and build a new metaverse with other NFT communities.`,
    image:
